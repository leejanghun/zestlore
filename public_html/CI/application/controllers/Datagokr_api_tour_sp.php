...
/// @author yym
///////////////////////////////////////////////////////////////////////////////
class Datagokr_api_tour_sp extends CI_Controller {
...
//		debug_var($this->is_cli_request());exit;
		...
		$url = 'https://apis.data.go.kr/B551011/SpnService/areaBasedList'; /*URL*/
...
//		$exe_cnt = 1; // 반복횟수
		...
		for($i=1;$i<=$exe_cnt;$i++) // $i=1
		{
			...
			for($item_i=0;$item_i<$numOfRows;$item_i++)
			{
				...
				$arrData['tbl_name']    =   'tourSp_500_default';


				// $arrData['arr_data']['tourSp_500_pk'] = $check_data['tourSp_500_pk'];
				$arrData['arr_data']['tourSp_500_addr1'] = $check_data['addr1'];
				$arrData['arr_data']['tourSp_500_addr2'] = $check_data['addr2'];
				$arrData['arr_data']['tourSp_500_areacode'] = $check_data['areacode'];
				$arrData['arr_data']['tourSp_500_cat1'] = $check_data['cat1'];
				$arrData['arr_data']['tourSp_500_cat2'] = $check_data['cat2'];
				$arrData['arr_data']['tourSp_500_cat3'] = $check_data['cat3'];
				$arrData['arr_data']['tourSp_500_contentid'] = $check_data['contentid'];
				$arrData['arr_data']['tourSp_500_contenttypeid'] = $check_data['contenttypeid'];
				$arrData['arr_data']['tourSp_500_createdtime'] = $check_data['createdtime'];
				$arrData['arr_data']['tourSp_500_firstimage'] = $check_data['firstimage'];
				$arrData['arr_data']['tourSp_500_firstimage2'] = $check_data['firstimage2'];
				$arrData['arr_data']['tourSp_500_mapx'] = $check_data['mapx'];
				$arrData['arr_data']['tourSp_500_mapy'] = $check_data['mapy'];
				$arrData['arr_data']['tourSp_500_mlevel'] = $check_data['mlevel'];
				$arrData['arr_data']['tourSp_500_modifiedtime'] = $check_data['modifiedtime'];
				$arrData['arr_data']['tourSp_500_readcount'] = $check_data['readcount'];
				$arrData['arr_data']['tourSp_500_sigungucode'] = $check_data['sigungucode'];
				$arrData['arr_data']['tourSp_500_tel'] = $check_data['tel'];
				$arrData['arr_data']['tourSp_500_title'] = $check_data['title'];
				$arrData['arr_data']['tourSp_500_zipcode'] = $check_data['zipcode'];
				$arrData['arr_data']['tourSp_500_moddt'] =  date("Y-m-d H:i:s");


//				$rtnString =  $this->TourSp_model->insert_tourSp_500_default( $arrData ); // 데이터 입력
