...
class Widget_admin_view extends Widget {
	...
	public function run( $arrayData )
	{
		...
		$arr_VARIABLE_DATA['url_go_modify'] .=   "index.php/admin_default/admin_modifyForm";
		$arr_VARIABLE_DATA['url_go_modify'] .=   "?admin_00_pk=".$arr_VARIABLE_DATA['admin_00_pk'];
		...
		return $this->CI->parser->parse('widgets/admin/widget_admin_view.html', $arr_VARIABLE_DATA, true);
