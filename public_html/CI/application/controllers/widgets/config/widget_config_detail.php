...
class Widget_config_detail extends Widget {
	...
	public function run( $arrayData )
	{
		...
		$arr_VARIABLE_DATA['url_go_modify'] .=   "index.php/config_default/config_modifyForm";
		...
		switch ($arr_config_100['config_10_input'])
		{
			...
			case "editor":
			case "radio":
				$parser_html = "widgets/config/widget_config_view.html";
				break;
		}
