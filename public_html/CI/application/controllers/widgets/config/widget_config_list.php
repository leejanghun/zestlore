...
class Widget_config_list extends Widget {
	...
	public function run( $arrayData )
	{
		...
		for($loopCnt_1 = 0; $loopCntLimit > $loopCnt_1; $loopCnt_1++)
		{
			...
			$arr_recordList[$loopCnt_1]['config_detail_url']   .=  "index.php/config_default/config_detail";
		...
		$htmlFilePath         =   "widgets/config/widget_config_list.html";
