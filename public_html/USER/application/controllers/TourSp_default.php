...
class TourSp_default extends CI_Controller {
...
//         echo "function name : ".__FUNCTION__."</br >";
	...
	public function tourSp_list()
	{
		...
		$this->arr_class_common["widget_contents"]	=	$this->widget->run(
			'widgets/tourSp/widget_tourSp_list'
			, array(
				'controller'	 	=>	get_class ( $this )
			,'function'			=>	__FUNCTION__
			,'sendData'			=>	$this->arr_segment
	...
	public function tourSp_detail()
	{
		...
		$this->arr_class_common["widget_contents"]	=	$this->widget->run(
			'widgets/tourSp/widget_tourSp_detail'
			, array(
				'controller'	 	=>	get_class ( $this )
			,'function'			=>	__FUNCTION__
			,'sendData'			=>	$this->arr_segment
	...
	public function tourSp_detail_dev()
	{
		// debug_var(simple_debug_backtrace());exit;
		...
		$this->arr_class_common["widget_contents"]	=	$this->widget->run(
			'widgets/tourSp/widget_tourSp_detail_dev'
			, array(
				'controller'	 	=>	get_class ( $this )
			,'function'			=>	__FUNCTION__
			,'sendData'			=>	$this->arr_segment
