...
class TourJp_default extends CI_Controller {
...
//         echo "function name : ".__FUNCTION__."</br >";
	...
	public function tourJp_list()
	{
		...
		$this->arr_class_common["widget_contents"]	=	$this->widget->run(
			'widgets/tourJp/widget_tourJp_list'
			, array(
				'controller'	 	=>	get_class ( $this )
			,'function'			=>	__FUNCTION__
			,'sendData'			=>	$this->arr_segment
	...
	public function tourJp_detail()
	{
		...
		$this->arr_class_common["widget_contents"]	=	$this->widget->run(
			'widgets/tourJp/widget_tourJp_detail'
			, array(
				'controller'	 	=>	get_class ( $this )
			,'function'			=>	__FUNCTION__
			,'sendData'			=>	$this->arr_segment
	...
	public function tourJp_detail_dev()
	{
		// debug_var(simple_debug_backtrace());exit;
		...
		$this->arr_class_common["widget_contents"]	=	$this->widget->run(
			'widgets/tourJp/widget_tourJp_detail_dev'
			, array(
				'controller'	 	=>	get_class ( $this )
			,'function'			=>	__FUNCTION__
			,'sendData'			=>	$this->arr_segment
