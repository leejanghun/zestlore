...
class Widget_hospital_list extends Widget {
	...
	public function run( $arrayData )
	{
		...
		$arr_SQL_Result	=   null;
		$arr_SQL_Result       =   $this->CI->Hospital_model->getHospital_RecordCnt( $arrData );
		...
		$arr_VARIABLE_DATA['url_go_list']   .=  "index.php/hospital_default/hospital_list";
		...
		$htmlFilePath         =   "widgets/hospital/widget_hospital_list.html";
