...
class Widget_tourEn_list extends Widget {
	...
	public function run( $arrayData )
	{
		...
		{
			$arr_sql_where[] = " tourEn_300_default.".$arr_VARIABLE_DATA['FILTER_FIELD_NAME'] . " Like '%" . $arr_VARIABLE_DATA['FILTER_FIELD_VALUE'] . "%'";
		...
		$arr_SQL_Result	=   null;
		$arr_SQL_Result       =   $this->CI->TourEn_model->getTourEn_RecordCnt( $arrData );
		...
		$arrData['OrderBy']        =   "tourEn_300_pk desc";
		...
		for($loopCnt_1 = 0; $loopCntLimit > $loopCnt_1; $loopCnt_1++)
		{
			...
			$arr_recordList[$loopCnt_1]['detail_url']   .=  "index.php/tourEn_default/tourEn_detail";
			$arr_recordList[$loopCnt_1]['detail_url']   .=   "?tourEn_300_pk=".$arr_SQL_Result[$loopCnt_1]['tourEn_300_pk'];
			...
			if($arr_SQL_Result[$loopCnt_1]['tourEn_300_firstimage2'])
			{
				$arr_recordList[$loopCnt_1]['tour_image'] = $arr_SQL_Result[$loopCnt_1]['tourEn_300_firstimage2'];
			}
		...
		$arr_FILTER_FIELD_OPTION_VALUE		=	array("tourEn_300_title", "tourEn_300_addr1");
		...
		$htmlFilePath         =   "widgets/tourEn/widget_tourEn_list.html";
