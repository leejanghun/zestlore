...
class TourSp_model extends CI_Model
{
	...
	public function getTourSp_RecordCnt( $arrData )
	{
		...
		$this->db->from( "tourSp_500_default" );
...
//         	        echo "<pre>";
	...
	public function getTourSp_RecordList( $arrData )
	{
		...
		$this->db->select("tourSp_500_default.*", FALSE);
	...
	public function update_tourSp_500_default( $arrData )
	{
		...
		try
		{
			...
			$this->db->where('tourSp_500_pk', $arrData['arr_data1']['tourSp_500_pk']);
			...
			if( $db_error["code"] == 0 )
			{
				...
				$rtnValue["SQL_Result_Data"]['tourSp_500_pk'] =   $arrData['arr_data1']['tourSp_500_pk'];
			}else{
